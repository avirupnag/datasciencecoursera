...
## Extract Global_active_power to global_active_power_data
global_active_power_data <- as.numeric(data$Global_active_power)

## Extract Global_reactive_power to global_reactive_power_data
global_reactive_power_data <- as.numeric(data$Global_reactive_power)

## Extract Voltage to voltage_data
...
## Set graph into 2 rows by 2 columns
par(mfrow = c(2, 2)) 

## Plot global_active_power_data against datetime
plot(datetime, global_active_power_data, type="l", xlab="", ylab="Global Active Power")

## Plot voltage_data against datetime
...
## Plot global_reactive_power_data against datetime
plot(datetime, global_reactive_power_data, type="l", xlab="datetime", ylab="Global_reactive_power")
